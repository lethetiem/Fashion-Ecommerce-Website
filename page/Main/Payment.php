...
<div class="payment">
      ...
      <h1 class="payment_td">SHIPPING</h1>
            ...
            <form id ="payment_form"action="" method="POST">
                  ...
                  <input type="text" class="payment_text1"  id ="street address" name="street address" placeholder="Street address" required />
                  ...
                  <input type="text" class="payment_text"  id ="email" name="email" placeholder="Email addres" required />
