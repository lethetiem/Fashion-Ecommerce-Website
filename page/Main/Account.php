...
//   }else{
//     $sql_select_register = mysqli_query($mysqli, "SELECT * FROM tbl_sregister WHERE username = '$username' AND password = '$password' LIMIT 1");
            ...
            data:  $( this ).serializeArray(),
              success: function(response){
                ...
                if(response.status==0){
                  ...
                  alert(response.message);
                  //location.reload();
                  //header("Refresh:0; url=Location:/SaleOnlineWebDeveloper/page/index.php?manager=AccountDashBoard");
                  
                  

                 // header('Location:/SaleOnlineWebDeveloper/page/index.php?manager=AccountDashBoard');
                  //window.location.href="/SaleOnlineWebDeveloper/page/index.php?manager=AccountDashBoard";
